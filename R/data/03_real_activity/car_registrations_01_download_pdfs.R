# ONE-TIME: Downloads historical monthly registration PDFs (2004–2020) from Samgöngustofa.
# PDFs are saved to samgongustofa_pdf/. Parsing was done interactively; output is
# samgongustofa_pdf/nyskraning_nyrra.csv. Re-run only if source PDFs need to be refreshed.
